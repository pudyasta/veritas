...
import { AvailableChartColors, type AvailableChartColorsKeys, getColorClassName } from "@/lib/chartUtils"
import { cx } from "@/lib/utils"

import { Tooltip } from "../ui/tooltip"

const getMarkerBgColor = (marker: number | undefined, values: number[], colors: readonly AvailableChartColorsKeys[]): string => {
          ...
          {marker !== undefined ? (
            ...
            >
              {marker.tooltip ? (
                ...
                <div
                  className={cx("mx-auto h-4 w-1 rounded-full ring-2", "ring-white dark:ring-gray-950", markerBgColor)}
                />
              )}
            </div>
          ) : null}
